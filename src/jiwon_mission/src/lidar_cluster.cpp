...
// ===== 전역 파라미터 =====
double eps_          = 0.2;   // 클러스터 간 거리 (20~25cm)
int    min_samples_  = 2;     // 최소 점 수
double follow_speed_ = 1500;  // 기본 주행 속도
double min_speed_    = 1100;  // 인식 안 될 때 속도
double k_yaw_        = 1.2;   // 조향 비율
...
int main(int argc, char** argv)
{
    ...
    // (필요하면 여기서 nh.param으로 eps_, follow_speed_ 같은 거 rosparam에서 로드 가능)
