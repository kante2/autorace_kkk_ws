...
Get current vehicle position (x, y, w, v)
Find nearest waypoint to vehicles current position.
Find the waypoint (goal point) closest to the lookahead.
Calculate alpha between the nearest waypoint and the goal point.
Calculate the curvature and steering angle.
Update the vehicles position, steering angle, velocity etc.
